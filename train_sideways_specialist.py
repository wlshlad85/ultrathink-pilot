#!/usr/bin/env python3
"""
Train Sideways Market Specialist Agent

Trains an agent specifically on sideways/consolidation market conditions.
...
def evaluate_on_validation(agent, device, initial_capital):
    """Evaluate agent on 2022 validation set (sideways periods only)."""
...
def train_sideways_specialist():
    """Train sideways market specialist."""

    print("=" * 80)
    print("SIDEWAYS MARKET SPECIALIST TRAINING")
    print("=" * 80)
    print()
    print("Training Configuration:")
    print("  Regime:            SIDEWAYS/CONSOLIDATION ONLY")
    print("  Reward System:     Sharpe-direct (risk-adjusted returns)")
    print("  Training Data:     2017-2021 sideways periods")
    print("  Validation Data:   2022 sideways periods")
    print()
    ...
    model_dir = root_dir / "rl" / "models" / "sideways_specialist"
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if episode % 10 == 0:
            ...
            # Validation
            print(f"  [VALIDATION] Testing on 2022 sideways periods...")
    ...
    print()
    print("=" * 80)
    print("SIDEWAYS SPECIALIST TRAINING COMPLETE!")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    try:
        metrics = train_sideways_specialist()
        print("=" * 80)
        print("✅ SIDEWAYS SPECIALIST TRAINING COMPLETED SUCCESSFULLY")
        print("=" * 80)
        sys.exit(0)
