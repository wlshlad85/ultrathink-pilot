#!/usr/bin/env python3
"""
Train Bull Market Specialist Agent

Trains an agent specifically on bull market conditions.
...
def evaluate_on_validation(agent, device, initial_capital):
    """Evaluate agent on 2022 validation set (bull periods only)."""
    val_env = RegimeSpecificTradingEnv(
        ...
        episode_length=100  # Shorter for validation
    )
...
def train_bull_specialist():
    """Train bull market specialist."""

    print("=" * 80)
    print("BULL MARKET SPECIALIST TRAINING")
    print("=" * 80)
    print()
    print("Training Configuration:")
    print("  Regime:            BULL MARKET ONLY")
    print("  Reward System:     Sharpe-direct (risk-adjusted returns)")
    print("  Training Data:     2017-2021 bull periods")
    print("  Validation Data:   2022 bull periods")
    print()
    ...
    model_dir = root_dir / "rl" / "models" / "bull_specialist"
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if episode % 10 == 0:
            ...
            # Validation
            print(f"  [VALIDATION] Testing on 2022 bull periods...")
    ...
    print()
    print("=" * 80)
    print("BULL SPECIALIST TRAINING COMPLETE!")
    print("=" * 80)
    print()
...
if __name__ == "__main__":
    try:
        metrics = train_bull_specialist()
        print("=" * 80)
        print("✅ BULL SPECIALIST TRAINING COMPLETED SUCCESSFULLY")
        print("=" * 80)
        sys.exit(0)
