...
from rl.simple_reward_strong import SimpleRewardCalculatorStrong
...
class SimpleTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        # Reward calculator
        self.reward_calculator = SimpleRewardCalculatorStrong(
            lookback_window=30,
            gain_weight=1000.0,
            loss_weight=100.0,
...
def train_simple_reward():
    ...
    print("=" * 80)
    print("EXPERIMENT 1: STRONG VOLATILITY PENALTY")
    print("=" * 80)
    print()
    ...
    model_dir = root_dir / "rl" / "models" / "exp1_strong"
    ...
    training_metrics = {
        ...
        "reward_type": "simple_reward_strong"
    }
